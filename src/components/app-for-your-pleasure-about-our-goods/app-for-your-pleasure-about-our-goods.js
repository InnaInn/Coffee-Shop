...
import './app-for-your-pleasure-about-our-goods.css';
import PictureWithCup from '../../images/Cup.jpg';
import LineBeansLogoHeaderBlack from '../../images/Beans logo.svg'


class AppForYourPleasureAboutOurGoods extends React.Component {
    render() {
        return <div>
            <div className="conteinerAboutOurBeans">
                <div className="imgBackground">
                    <img className="pictureWithCup" src={PictureWithCup} alt="Background" />
                </div>
...
export default AppForYourPleasureAboutOurGoods;